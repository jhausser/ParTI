%% demo_sisal_large_n_p
%
% This demo illustrates  SISAL algorithm [1]  runnig with a 20000 pixels
% and p = 15.
%
% This is not, by far, the maximum size the algorithm can work with. Try, 
% for example, N = 100000.
%
%
...
N = 20000;                   % number of pixels
SNR = 100;                   % signal-to-noise ratio (E ||y||^2/E ||n||^2) in dBs
